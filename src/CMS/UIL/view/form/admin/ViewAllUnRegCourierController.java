...
public class ViewAllUnRegCourierController {
	...
	@FXML private TableColumn<CourierModel, String> scontact;
	@FXML private TableColumn<CourierModel, String> scnic;
	@FXML private TableColumn<CourierModel, String> rname;
	@FXML private TableColumn<CourierModel, String> raddr;
	@FXML private TableColumn<CourierModel, String> rcontact;
	...
	public void init(Admin a) {
		...
		admin = a;
		// get the courier list
		list= admin.getCourierList(p);
		// make a copy of list
	    listcopy = list;
        ...
        scontact.setCellValueFactory(cellData -> cellData.getValue().ScontactNumber);
        scnic.setCellValueFactory(cellData -> cellData.getValue().SCNIC);
        
        rname.setCellValueFactory(cellData -> cellData.getValue().rname);
        raddr.setCellValueFactory(cellData -> cellData.getValue().raddr);
        rcontact.setCellValueFactory(cellData -> cellData.getValue().rcontact);
